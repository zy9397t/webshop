  ...
  <div class="Msite">
    ...
    <div class="mainConetent">
          ...
          ><div class="grid-content bg-purple">
            <ul class="cotegories">
              <li v-for="(items, index) in cotegories" :key="index">
                <ul class="cotegory">
                  <li v-for="(cotegory, index) in items" :key="index">
                    >{{ cotegory }}
                  </li>
                </ul>
              </li>
          ...
          ><div class="grid-content bg-purple">
            <div class="more">
              <div class="top">
                <h1>HI,你好</h1>
                <h2>
                  <span @click="redirect('login')" class="cup">登录</span>|<span
                    class="cup"
                    @click="redirect('regist')"
                    >注册</span
                  >
                </h2>
                <div class="fuli">
                  <span>新人福利</span><span>PLUS会员</span>
                </div>
              </div>
              <div class="center">
                <h1>
                  <span class="kb">快报</span> <span class="gd">更多>></span>
                </h1>
                <ul>
              ...
              <div class="bottom">
                ...
                <div>
                  <span>游戏</span><span>加油卡</span><span>火车票</span>
                </div>
                <div><span>众筹</span><span>理财</span><span>白条</span></div>
                <div>
                  <span>电影票</span><span>企业购</span><span>礼品卡</span>
                </div>
              </div>
            </div>
          </div></el-col
      ...
      <el-row :gutter="2" class="main2">
        <el-col :span="4" :offset="2"
          ><div class="grid-content bg-purple count_down">
            ...
            >
              <el-carousel-item v-for="item in 2" :key="item" class="cards">
                <div class="card" v-for="item2 in 4" :key="item2">
                  ...
                  <div class="info">vivo X60系列5G手机</div>
                  <div class="price">￥3798.00</div>
                </div>
              </el-carousel-item>
            </el-carousel>
          </div></el-col
